...
def listMaker():
    ...
    for eachRoute in ALL_ROUTE_IDS:
        ...
        if len(ALL_ROUTE_IDS[eachRoute]) == 143:
            print('ITS DONE')
            sys.exit()
    ...
    for j in range(11):
        for k in range(11):
            for l in range(11):
                ...
                print(disSIDBY, disEDDYY2, disEDDYY3, disNARWL)
                disNARWL -= 0.1
            disNARWL = 1
            disEDDYY3 -= 0.1
        disEDDYY3 = 1
